(function() {
  ...
  this["linearity"] = function(T, done) {
  ...
  if (module.parent == null) {
    include = ["sorting", "existence", "deletion", "root nodes, lone nodes (1)", "root nodes, lone nodes (2)", "copy (1)", "copy (2)", "group (1)", "group (2)", "group (3)", "group (4)", "test for lone node", "demo (1)", "demo (2)", "demo (3)", "demo (4)", "using precedents, actions, and consequents", "cycle detection (1)", "cycle detection (2)", "linearity", "avoid reduplication"];
    this._prune();
    this._main();
  }
