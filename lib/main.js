(function() {
  ...
  Ltsort = class Ltsort {
      ...
      for (j = 0, len1 = ref2.length; j < len1; j++) {
        ...
        if (relative === '*') {
          if (ref3 = cfg.name, indexOf.call(this.antecedents, ref3) < 0) {
            this.antecedents.unshift(cfg.name);
          }
          continue;
        }
    ...
    _finalize() {
      ...
      ref = this.antecedents;
      //.......................................................................................................
      for (idx = i = 0, len = ref.length; i < len; idx = ++i) {
        antecedent = ref[idx];
        ref1 = [...names, ...this.antecedents.slice(0, idx), ...this.subsequents];
      ...
      ref2 = this.subsequents;
      //.......................................................................................................
      for (idx = k = 0, len2 = ref2.length; k < len2; idx = ++k) {
        subsequent = ref2[idx];
        ref3 = [...names, ...this.subsequents.slice(0, idx), ...this.antecedents];
